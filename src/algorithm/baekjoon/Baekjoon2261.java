...
public class Baekjoon2261 {
    ...
    private static Comparator<Element> yCompare =
            new Comparator<>() {
                @Override
    ...
    private static Comparator<Element> xCompare =
            new Comparator<>() {
                @Override
                public int compare(Element o1, Element o2) {
                    return o1.x - o2.x;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            elements[i] =
                    new Element(Integer.parseInt(st.nextToken()), Integer.parseInt(st.nextToken()));
        }
